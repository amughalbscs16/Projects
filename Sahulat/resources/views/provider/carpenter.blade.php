...
@section('content')
    <div class="col-12 col-m-12 col-t-12 left image_container">
        <div class="col-12 col-m-12 col-t-12 left"><img src="{{URL::asset('images')}}/carpenter.jpg" width="100%" height="20%"></div>
        <div class="overlay">
            <span class="left" style="text-align: center;">Broke your furniture? Or want a new one? <br>Choose a carpenter and get your problem fixed right-away!</span>
        </div>
    </div>
    @if($count>0)
    <div class="col-12 col-m-12 col-t-12 left container-1">
      ...
      <div id="row" class="col-12 col-m-12 col-t-12 left">
        ...
        <a href="{{route('getCarpenterProfile',['service_id'=>$services[$i]->service_id,'provider_id'=>$services[$i]->provider_id])}}">
