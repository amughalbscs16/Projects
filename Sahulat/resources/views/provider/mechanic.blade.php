...
@section('content')
    <div class="col-12 col-m-12 col-t-12 left image_container">
        <div class="col-12 col-m-12 col-t-12 left"><img src="{{URL::asset('images')}}/mechanic.jpg" width="100%" height="20%"></div>
        <div class="overlay">
            <span class="left" style="text-align: center;">Did your car break down?<br><br>No worries, we have got the best <br>mechanics for your car</span>
        </div>
    </div>
    @if($count>0)
    <div class="col-12 col-m-12 col-t-12 left container-1">
      ...
      <div id="row" class="col-12 col-m-12 col-t-12 left">
        ...
        <a href="{{route('getMechanicProfile',['service_id'=>$services[$i]->service_id,'provider_id'=>$services[$i]->provider_id])}}">
