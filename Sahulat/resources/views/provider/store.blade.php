...
@section('content')
    <div class="col-12 col-m-12 col-t-12 left image_container">
        <div class="col-12 col-m-12 col-t-12 left"><img src="{{URL::asset('images')}}/Store.jpg" width="100%" height="20%"></div>
        <div class="overlay">
            <span class="left" style="text-align: right; margin-left: 50%;"><br>Got any sanitary issues? <br><br>Call a Store and get it fixed!</span>
        </div>
    </div>
    <div class="col-12 col-m-12 col-t-12 left container-1">
         ...
         <div id="row" class="col-11 col-m-12 col-t-11 left">
           @if ($count > 0)
           <a href="{{route('getStoreProfile',['service_id'=>$services[0]->service_id,'provider_id'=>$services[0]->provider_id])}}">
           ...
           @endif
           @if ($count > 1)
           <a href="{{route('getStoreProfile',['service_id'=>$services[1]->service_id,'provider_id'=>$services[1]->provider_id])}}">
           ...
           @endif
           @if ($count > 2)
           <a href="{{route('getStoreProfile',['service_id'=>$services[2]->service_id,'provider_id'=>$services[2]->provider_id])}}">
           ...
           @endif
           @if ($count > 3)
           <a href="{{route('getStoreProfile',['service_id'=>$services[3]->service_id,'provider_id'=>$services[3]->provider_id])}}">
           <div class="card two col-2 col-m-11 col-t-8 left">
             <div class="col-12 col-m-12 col-t-12 left">
           ...
           @endif
           @if ($count > 4)
           <a href="{{route('getStoreProfile',['service_id'=>$services[4]->service_id,'provider_id'=>$services[4]->provider_id])}}">
           <div class="card one col-1 col-m-11 col-t-6 left">
             <div class="col-12 col-m-12 col-t-12 left">
       ...
       <div class="col-12 col-m-12 col-t-12 left container-2">
         ...
         <div id="row" class="col-12 col-m-12 col-t-12 left">
           <div class="col-3 col-m-12 col-t-11 left">
             @if ($count > 5)
             <a href="{{route('getStoreProfile',['service_id'=>$services[5]->service_id,'provider_id'=>$services[5]->provider_id])}}">
             ...
             @endif
             @if ($count > 6)
             <a href="{{route('getStoreProfile',['service_id'=>$services[6]->service_id,'provider_id'=>$services[6]->provider_id])}}">
             <div class="card col-12 col-m-12 col-t-5 left">
           ...
           @if ($count > 7)
           <a href="{{route('getStoreProfile',['service_id'=>$services[7]->service_id,'provider_id'=>$services[7]->provider_id])}}">
           ...
           <div class="col-3 col-m-12 col-t-11 left">
             @endif
             @if ($count > 8)
             <a href="{{route('getStoreProfile',['service_id'=>$services[8]->service_id,'provider_id'=>$services[8]->provider_id])}}">
             <div class="card col-12 col-m-12 col-t-5 left">
             ...
             @endif
             @if ($count > 9)
             <a href="{{route('getStoreProfile',['service_id'=>$services[9]->service_id,'provider_id'=>$services[9]->provider_id])}}">
             <div class="card col-12 col-m-12 col-t-5 left">
    ...
    <div class="col-12 col-m-12 col-t-12 left container-3">
      ...
      <div id="row" class="col-12 col-t-12 left">
        @for ($i =$count-1; $i>=7; $i--)
        <a href="{{route('getStoreProfile',['service_id'=>$services[$i]->service_id,'provider_id'=>$services[$i]->provider_id])}}">
