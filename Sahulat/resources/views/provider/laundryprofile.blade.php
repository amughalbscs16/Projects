...
<div class = "hariscss">
<center>
  <div class="carpenterheader" style="background-color:rgba(5,130,250,0.3);">
     <h2>Laundry</h2>
  </div>
      </center>
      <!--line break-->
        ...
        <div class = "col-7 col-m-12 col-t-12 left info" style="background-color: rgba(5,130,250,0.4); border-radius:20px;">
        <p id = "#provderName" style = "text-align: left;">
          <b style="opacity: 0.5">
            Address:
          </b>
          <span style ="color:black;"><b>{{$provider->address}}</b>
          </span>
      </p>
